...
Napi::Object BaseSystem::Init(Napi::Env env, Napi::Object exports) {
    ...
    Napi::Function func = DefineClass(env, "BaseSystem", {
        ...
        StaticMethod<&BaseSystem::Uname>("uname", static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
...
Napi::Value BaseSystem::Uname(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
